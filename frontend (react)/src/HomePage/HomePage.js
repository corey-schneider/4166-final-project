	...
	render() {
		return (
			<>
				...
				<br/><h2 style="color:red">Please read before using this app!!!</h2>
				<p>There seems to be an issue with login / registration after going to the dashboard.<br/>
				<strong>Please DO NOT visit the dashboard UNTIL you have tested login and registration.</strong><br/>
				I am still working on fixing this issue. Thank you!</p>
			</>
		);
	}
}
